    ...
    <div id="resume" className="section-padding divider">
      <div className="container">
        ...
        {careers.map((item, idx) => (
          <div key={idx} className="row mt-4 gx-0 gy-4 p-5 border-hover rounded-5 shadow" data-aos="fade-up" data-aos-delay="200">
            <div className="col-md-3">
              <img src={item.logo} alt="" />
            </div>
            <div className="col-md-3">
              <h5>{item.position}</h5>
              <small className="text-info">{item.from}-{item.to}</small>
            </div>
